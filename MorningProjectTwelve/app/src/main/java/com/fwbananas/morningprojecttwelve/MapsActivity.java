package com.fwbananas.morningprojecttwelve;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(emobilis).title("Marker in emoblis"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(emobilis));

        LatLng Nakuru = new LatLng(-0.3158109, 35.9387736);
        ...
        LatLng Meru = new LatLng(0.1443445, 37.1947874);
